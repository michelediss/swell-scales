...
function generateClasses() {
    ...
    if (btnConfig) {
        ...
        const baseColor = colorScheme[schemeBase] && colorScheme[schemeBase][toneBase]; // Get the corresponding base color
        if (baseColor) {
        ...
        const hoverColor = colorScheme[schemeHover] && colorScheme[schemeHover][toneHover]; // Get the corresponding hover color
        if (hoverColor) {
